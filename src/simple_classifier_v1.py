...
for n_layers in range(2, 6):
    ...
    plt.tight_layout()
    plt.savefig(f"figures/v1/loss_{n_layers}_n_layers.png", dpi=200)

    plot_decision_boundary(X_test, y_test, best_theta[n_layers - 2], n_layers, f'figures/v1/decision_boundary_{n_layers}.png')
